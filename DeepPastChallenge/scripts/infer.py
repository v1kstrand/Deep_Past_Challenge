...
from DeepPastChallenge.infer import run_inference_from_config  # noqa: E402
...
def infer(*, overrides: dict[str, Any] | str | Path | None = None) -> None:
    cfg = _load_overrides(overrides) or {}
